...
//     private _tradeFetchPaused: boolean = false;
...
//     public override on<K extends keyof TradeEvents>(event: K, listener: (...args: TradeEvents[K]) => void): this {
//         return super.on(event, listener);
//     }
//     public override emit<K extends keyof TradeEvents>(event: K, ...args: TradeEvents[K]): boolean {
